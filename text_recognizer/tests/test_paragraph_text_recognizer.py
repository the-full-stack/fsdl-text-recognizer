...
class TestParagraphTextRecognizer(unittest.TestCase):
    ...
    def test_filename(self):  # pylint: disable=R0201
        ...
        for filename in (SUPPORT_DIRNAME).glob('*.jpg'):
            ...
            # Sample predicted_text: "d M0VE to stop Mr. Gaitskell Aron woninating any mone habour life Peers is to be made at a meetig af Labaur M Ps toorrow. Ir. Mclael Foot kas put dou a vesoltion on the sujech ond he is to ee bached by Mr. Will Griftiths, MP for Nancheder Eroange."
